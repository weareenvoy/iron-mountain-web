...
const SecondScreenTemplate = ({ item1Body, item1Image }: SecondScreenTemplateProps) => {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute top-[1960px] left-[-400px] z-[1] size-[1400px] group-data-[kiosk=kiosk\_2]/kiosk:top-[1660px] group-data-[kiosk=kiosk\_2]/kiosk:left-[-360px] group-data-[kiosk=kiosk\_2]/kiosk:size-[1380px] group-data-[kiosk=kiosk\_3]/kiosk:top-[1610px] group-data-[kiosk=kiosk\_3]/kiosk:left-[-360px] group-data-[kiosk=kiosk\_3]/kiosk:size-[1350px]">
        {item1Image && (
          <Image
      ...
      <div className="relative top-[1660px] left-[640px] z-[2] px-[120px] py-[250px] group-data-[kiosk=kiosk\_2]/kiosk:top-[1190px] group-data-[kiosk=kiosk\_3]/kiosk:top-[290px] ">
        <p className="max-w-[1000px] text-[60px] leading-[1.3] font-normal tracking-[-3px] text-white group-data-[kiosk=kiosk\_2]/kiosk:w-[1100px] group-data-[kiosk=kiosk\_3]/kiosk:max-w-[1100px]">
