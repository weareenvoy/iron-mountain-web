...
const ThirdScreenTemplate = ({
  ...
  return (
    ...
    >
      ...
      >
        <p
          className="max-w-[1090px] text-[60px] leading-[1.3] font-normal tracking-[-3px] text-white group-data-[kiosk=kiosk-2]/kiosk:w-[1070px] group-data-[kiosk=kiosk-3]/kiosk:max-w-[1070px]"
        >
