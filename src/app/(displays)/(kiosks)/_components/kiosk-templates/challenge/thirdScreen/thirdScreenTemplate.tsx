...
const ThirdScreenTemplate = ({ featuredStat2, featuredStat2Body, item2Body, item2Image }: ThirdScreenTemplateProps) => {
  return (
    ...
    >
      ...
      <div
        className="relative top-[1740px] left-[-20px] z-[2] px-[120px] py-[250px] group-data-[kiosk=kiosk-2]/kiosk:top-[1410px] group-data-[kiosk=kiosk-2]/kiosk:left-0 group-data-[kiosk=kiosk-3]/kiosk:top-[290px]"
        data-scroll-section="challenge-third-description"
      >
        <p className="max-w-[1090px] text-[60px] leading-[1.3] font-normal tracking-[-3px] text-white group-data-[kiosk=kiosk-2]/kiosk:w-[1070px] group-data-[kiosk=kiosk-3]/kiosk:max-w-[1070px]">
