...
export interface HardCodedKiosk1InitialScreenTemplateProps {
...
export default function HardCodedKiosk1InitialScreenTemplate({
...
}: HardCodedKiosk1InitialScreenTemplateProps) {
