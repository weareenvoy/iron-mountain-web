  ...
  return (
    <div className="absolute inset-0 z-[200] flex items-center justify-center pointer-events-auto">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative z-[201] flex h-[2800px] w-[1920px] max-h-[90vh] flex-col overflow-hidden rounded-[48px] bg-[#97e9ff] p-[80px] text-[#14477d] shadow-[0_40px_120px_rgba(0,0,0,0.45)]">
          ...
          {content.imageSrc ? (
            <div className="flex items-center justify-center">
              <div className="relative top-[130px] h-[1680px] w-[1680px] rotate-[45deg] rounded-[80px] border-0 bg-transparent">
                <div className="absolute inset-0 -rotate-[45deg] flex items-center justify-center rounded-[80px] bg-transparent">
                  <NextImage
