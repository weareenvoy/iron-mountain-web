  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        className="absolute top-[200px] w-[500px] left-[120px] text-[60px] leading-[1.4] font-normal tracking-[-3px] whitespace-pre-line text-[#ededed] will-change-transform group-data-[ci=ci-2]/ci:left-[120px] group-data-[ci=ci-3]/ci:top-[240px]"
      ...
      >
        {/* Eyebrow */}
        <h2 className="px-[120px] pt-[240px] pb-[375px] pl-[150px] w-[700px] text-[60px] leading-[1.4] font-normal tracking-[-3px] whitespace-pre-line text-[#ededed]">
          {renderRegisteredMark(eyebrowText)}
        </h2>
      </div>
