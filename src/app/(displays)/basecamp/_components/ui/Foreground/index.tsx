        ...
        return (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-secondary-im-purple space-y-8 text-center">
              <div className="text-5xl font-bold">{possibilitiesData.title}</div>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-secondary-im-purple space-y-8 text-center">
              ...
              <div className="grid grid-cols-2 gap-8">
                {/* Challenge 1 */}
                <div className="text-2xl font-semibold">{problem3Data['challenge-1'].title}</div>
                <div className="text-lg">{problem3Data['challenge-1'].body}</div>
                {/* Challenge 2 */}
                <div className="text-2xl font-semibold">{problem3Data['challenge-2'].title}</div>
                <div className="text-lg">{problem3Data['challenge-2'].body}</div>
                {/* Challenge 3 */}
                <div className="text-2xl font-semibold">{problem3Data['challenge-3'].title}</div>
                <div className="text-lg">{problem3Data['challenge-3'].body}</div>
                {/* Challenge 4 */}
                <div className="text-2xl font-semibold">{problem3Data['challenge-4'].title}</div>
                <div className="text-lg">{problem3Data['challenge-4'].body}</div>
              </div>
            </div>
          </div>
        );
