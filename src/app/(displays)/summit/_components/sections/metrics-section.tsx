...
const MetricsSection = ({ metrics, obstacles }: MetricsSectionProps) => {
  return (
    <section className="flex flex-col gap-12">
      ...
      <div className="rounded-xl border border-[#6DCFF6] bg-white px-6 py-8 shadow-sm sm:px-8 lg:px-10 lg:py-10">
          ...
          {obstacles.items.map(item => (
            <article className="flex flex-col items-center gap-4 text-center" key={item.title}>
              ...
              <div className="flex h-28 w-28 items-center justify-center">
                <div className="flex h-24 w-24 -rotate-45 items-center justify-center rounded-xl border border-[#44A6E6] bg-white">
                  <div className="relative flex h-20 w-20 rotate-45 items-center justify-center rounded-full ">
                    <Image alt="" height={100} src="/images/binary-code-circle.png" width={100} />
                  </div>
                </div>
              </div>
