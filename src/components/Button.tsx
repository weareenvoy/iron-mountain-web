...
const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center prispace-nowrap rounded-full font-medium [&_svg]:pointer-events-none transition-all disabled:pointer-events-none disabled:cursor-not-allowed shrink-0 [&_svg]:shrink-0 outline-none duration-300",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        lg: "h-30 text-[40px] px-8 py-6 gap-3.5",
      },
      icon: {
        true: "",
        false: "",
