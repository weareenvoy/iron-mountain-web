  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            "font-body-xs w-full bg-foreground-secondary-2 p-4 shadow-xl border-l-4 border-brand-primary flex row-reverse items-center gap-4 line-clamp-3",
          icon: "h-5 w-5 order-first text-brand-primary",
          closeButton:
